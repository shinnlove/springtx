 ...
 */
package com.shinnlove.springtx.calabash;
 ...
 * @version $Id: CalabashBoyTest.java, v 0.1 2018-07-13 下午6:14 shinnlove.jinsheng Exp $$
 */
...
public class CalabashBoyTest {
    ...
    @Test
    public void Transactional注解驱动的声明式事务_测试() {
        jdbcTemplate.update("insert into calabash_boy (name, mana) values (?, ?)", "Fire Calabash",
            "100");
        jdbcTemplate.update("insert into calabash_boy (name, mana) values (?, ?)",
            "Water Calabash", "200");
    ...
    @Test
    public void Transactional注解驱动的声明式事务_回滚() {
        jdbcTemplate.update("insert into calabash_boy (name, mana) values (?, ?)", "Fire Calabash",
            "100");
        jdbcTemplate.update("insert into calabash_boy (name, mana) values (?, ?)",
            "Water Calabash", "100");
